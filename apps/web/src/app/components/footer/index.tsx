...
const Footer = () => {
  return (
    <div className="bg-[#333333] md:px-20 md:py-12 p-10">
      <div className="bg-[#F5F5F566] h-0.5 w-full " />
      <div className='flex md:flex-row flex-col justify-between md:py-12 py-10 text-[#F5F5F5]'>
        <div className="flex md:flex-row flex-col gap-x-10 gap-y-6 md:gap-y-0">
          <div>
            <AppIcon />
            <p className="pt-4">
              Join thousands of women achieving <br /> their dreams with
              HappyWoman.
            </p>
          </div>
          <div>
